    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        return MyExpansionPanel(
          ...
          panelTitle: '${ToolDateFormatter.formatToMonthDayWeek(date) ?? 'No Date'}_ ${items.length} _ ${'77'} min',
          widgetHeight: 45,
        );
      },
    );
      ...
      child: InkWell(
        ...
        child: AnimatedContainer(
          ...
          decoration: BoxDecoration(
            color: isClicked ? Colors.grey[200] : Colors.blue[100],
              ...
              children: [
                ...
                InkWell(
                  onTap: () => Get.find<AllItemControlBloc>()
                      .add(ChangeItemEvent(todoItem: widget.todoItem)),
